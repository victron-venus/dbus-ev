# Pinned upstream entity definitions preserve existing HA identities.
...
SERVICE_BATTERY_MAX_SOC_CONFIGURE_SCHEMA = vol.Schema(
    {
        ...
        vol.Required("max_soc", default=100): vol.All(
            vol.Coerce(int), vol.In([30, 40, 50, 60, 70, 80, 90, 100])
        ),
...
SERVICE_PRECONDITIONING_CONFIGURE_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional("departure_time", default=0): vol.All(
